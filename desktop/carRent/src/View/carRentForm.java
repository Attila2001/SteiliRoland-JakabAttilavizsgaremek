 ...
 * @author resahh
 */
public class carRentForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        renterTb = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        renterTbl = new javax.swing.JTable();
        carTb = new javax.swing.JPanel();
        ...
        renterTb.setLayout(new java.awt.GridLayout(1, 1));

        renterTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(renterTbl);

        renterTb.add(jScrollPane1);

        tableTb.addTab("Kölcsönzők", renterTb);

        carTb.setLayout(new java.awt.GridLayout(1, 1));
        ...
        carTb.add(jScrollPane2);

        tableTb.addTab("Autók", carTb);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(carRentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new carRentForm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable renterTbl;
    ...
    public JPanel getCarTb() {
        return carTb;
    }

    public JTable getCarTbl() {
        return carTbl;
    }

    public JPanel geRenterTb() {
        return renterTb;
    }

    public JTable getRenterTbl() {
        return renterTbl;
    }
